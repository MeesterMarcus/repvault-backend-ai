...
export const predefinedExercises: ExerciseTemplate[] = [
  ...
  },
  {
    ...
    equipment: 'Bodyweight',
    sets: [],
    description: 'Start in a plank position and quickly jump your feet apart and together like a horizontal jumping jack.',
    imageUri: 'Plank Jacks.mp4'
  },
  {
    id: 'skater_jumps',
    name: 'Skater Jumps',
    ...
    equipment: 'Bodyweight',
    sets: [],
    description: 'Leap laterally from one leg to the other, landing softly and using your arms for balance.',
    imageUri: 'Skater Jumps.mp4'
  },
  {
    id: 'tuck_jumps',
    name: 'Tuck Jumps',
    ...
    equipment: 'Bodyweight',
    sets: [],
    description: 'Explosively jump upward from a squat position while tucking your knees toward your chest, then land softly and repeat.',
    imageUri: 'Tuck Jumps.mp4'
  },
  {
    id: 'butt_kickers',
    name: 'Butt Kickers',
    ...
    equipment: 'Bodyweight',
    sets: [],
    description: 'Run in place while rapidly kicking your heels up toward your glutes to boost your heart rate.',
    imageUri: 'Butt Kickers.mp4'
  },
  {
    id: 'inchworm_walkouts',
    name: 'Inchworm Walkouts',
    category: 'Cardio',
    muscleGroup: ['Core', 'Arms'],
    equipment: 'Bodyweight',
    sets: [],
    description: 'From a standing position, bend at the waist to touch the floor, walk your hands forward into a plank, then reverse the motion back to standing.',
    imageUri: 'Inchworm Walkouts.mp4'
  },
  {
    id: 'lateral_shuffles',
    ...
    equipment: 'Bodyweight',
    sets: [],
    description: 'Quickly move side-to-side in a low squat position to improve agility and elevate your heart rate.',
    imageUri: 'Lateral Shuffles.mp4'
  },
  {
    id: 'broad_jumps',
    name: 'Broad Jumps',
    ...
    equipment: 'Bodyweight',
    sets: [],
    description: 'Begin in a squat and explode forward with a powerful jump, landing softly to absorb the impact.',
    imageUri: 'Broad Jumps.mp4'
  },
  {
    id: 'quick_feet',
    name: 'Quick Feet',
    ...
    equipment: 'Bodyweight',
    sets: [],
    description: 'Rapidly lift and lower your feet in place, simulating a fast-paced run or agility drill.',
    imageUri: 'Quick Feet.mp4'
  },
  {
    id: 'star_jumps',
    name: 'Star Jumps',
    ...
    equipment: 'Bodyweight',
    sets: [],
    description: 'From a squat position, explosively jump outward into a star shape by extending your arms and legs, then return to the squat.',
    imageUri: 'Star Jumps.mp4'
  },
  {
    id: 'frog_jumps',
    name: 'Frog Jumps',
    ...
    equipment: 'Bodyweight',
    sets: [],
    description: 'Start in a squat, place your hands on the floor, then jump forward like a frog, landing softly and repeating the motion.',
    imageUri: 'Frog Jumps.mp4'
  },
  {
    id: 'hack_squats',
    name: 'Hack Squats',
    ...
    sets: [],
    description: 'Position your shoulders under the pads, place your feet shoulder-width apart on the platform, lower your body until your thighs are parallel to the floor, then push back up.',
    imageUri: 'Hack Squats.mp4'
  },
  {
    ...
    sets: [],
    description: 'Position yourself under the Smith machine bar, squat down keeping your back straight, then push through your heels to return to standing.',
    imageUri: 'Smith Machine Squats.mp4'
  },
  {
    id: 'leg_abductions',
    name: 'Leg Abductions',
    category: 'Strength',
    muscleGroup: ['Legs'],
    equipment: 'Leg Abduction Machine',
    sets: [],
    description: 'Sit on the leg abduction machine, press your legs outward against resistance, then slowly return to the starting position.',
    imageUri: 'Leg Abductions.mp4'
  },
  {
    id: 'leg_adductions',
    name: 'Leg Adductions',
    category: 'Strength',
    muscleGroup: ['Legs'],
    equipment: 'Leg Adduction Machine',
    sets: [],
    description: 'Sit on the leg adduction machine, squeeze your legs together against resistance, then slowly release to the starting position.',
    imageUri: 'Leg Adductions.mp4'
  },
  {
    ...
    sets: [],
    description: 'Sit on the calf raise machine with the pads on your thighs, push upward using your calf muscles, and slowly lower back down.',
    imageUri: 'Seated Calf Raises.mp4'
  },
  {
    ...
    sets: [],
    description: 'Stand facing a cable machine with a rope attachment, hold the rope with a neutral grip, and curl it towards your shoulders while keeping your elbows close to your body.',
    imageUri: 'Cable Hammer Curls.mp4'
  },
  {
    ...
    equipment: 'Cable Machine',
    sets: [],
    description: 'Stand facing away from the cable machine with a rope attachment held overhead, extend your arms forward to work the triceps, then slowly return.',
    imageUri: 'Cable Rope Overhead Triceps Extension.mp4'
  },
  {
    id: 'chest_supported_dumbbell_rows',
    name: 'Chest Supported Dumbbell Rows',
    category: 'Strength',
    muscleGroup: ['Back'],
    equipment: 'Dumbbells',
    sets: [],
    description: 'Lie face down on an incline bench, row dumbbells towards your chest by squeezing your shoulder blades together, and slowly lower them back down.',
    imageUri: 'Chest Supported Dumbbell Rows.mp4'
  },
  {
    ...
    equipment: 'Cable Machine',
    sets: [],
    description: 'Stand sideways to a cable machine, hold the handle with the outside hand, raise your arm laterally to shoulder height, then slowly lower it.',
    imageUri: 'Cable Lateral Raises.mp4'
  },
  {
    ...
    equipment: 'Cable Machine',
    sets: [],
    description: 'Stand facing the cable machine with handles set at shoulder height, pull the cables outward with a slight bend in your elbows to engage the rear delts and upper back, then return slowly.',
    imageUri: 'Cable Reverse Flyes.mp4'
  }
